<?php
    ...
    $Email -> addReplyTo('Info@cursivehomenumbers.com','Cursive home numbers');

    $Email -> AddAddress ('homenumberguy@gmail.com','Cursive home numbers');


    $Email -> Subject = "New Inquiry From homenumberguy.com";
